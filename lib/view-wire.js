...
export const researchViewRequestSchema = z.object({ sessionId, planId: positive.optional(), versionPage: page.optional(), runPages: runPages.optional(), ifNoneMatch: snapshotId.optional(), refresh: z.boolean().optional() }).strict().transform(({ versionPage: _obsolete, ...request }) => request);
