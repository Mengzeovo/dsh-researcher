...
export interface ResearchReadContext {
...
export interface ResearchViewPlanRecord {
    readonly document: PlanDocument;
    readonly path: string;
}
export interface ResearchViewRunRecord {
...
export type ResearchViewResponse = ResearchViewSnapshot | {
    readonly kind: 'unbound';
} | {
    readonly kind: 'unchanged';
    readonly snapshotId: ResearchViewSnapshotId;
};
export interface ResearchViewWatchRequest {
    readonly sessionId: string;
}
export interface ResearchViewNodeRequest {
    readonly sessionId: string;
    readonly snapshotId: ResearchViewSnapshotId;
    readonly nodeId: ResearchViewNodeId;
}
export type ResearchViewNodeDetail = {
    readonly kind: 'plan';
    readonly node: ResearchPlanViewNode;
    readonly document: PlanDocument;
} | {
    readonly kind: 'run';
    readonly node: ResearchRunViewNode;
...
export interface ResearchViewChanged {
    readonly targetToken: ResearchViewTargetToken;
}
export {};
