...
export const researchViewRequestSchema: z.ZodType<ResearchViewRequest> = z.object({ sessionId, planId: positive.optional(), versionPage: page.optional(), runPages: runPages.optional(), ifNoneMatch: snapshotId.optional(), refresh: z.boolean().optional() }).strict()
