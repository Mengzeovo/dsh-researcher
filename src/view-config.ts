...
export interface ResearcherConfig { readonly view: ResearchViewConfig }
...
export function resolveResearcherConfig(input: unknown): ResearcherConfig { return researcherConfigSchema.parse(input ?? {}) }
