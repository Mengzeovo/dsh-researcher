...
export const en = {
  ...
  empty: 'This target has no saved plan versions yet.', chooseNode: 'Select a plan version or run to inspect its record.',
  unavailable: 'Diagram unavailable', error: 'The view could not finish this request.',
  plan: 'Plan {id}', revision: 'Version {revision}', versions: '{count} versions', runs: '{count} runs',
  warnings: '{count} warnings', versionPages: 'Version pages', runPages: 'Runs for version {revision}',
...
export const zh = {
  ...
  empty: '此目标尚无已保存的方案版本。', chooseNode: '选择方案版本或 Run 以查看其记录。',
  unavailable: '关系图不可用', error: '本次视图请求未能完成。',
  plan: '方案 {id}', revision: '版本 {revision}', versions: '{count} 个版本', runs: '{count} 个 Run',
  warnings: '{count} 条警告', versionPages: '版本分页', runPages: '版本 {revision} 的 Run',
