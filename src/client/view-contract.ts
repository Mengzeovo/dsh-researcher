...
import type {} from './view-locales.ts'

declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    'research.view.diagram': { kind: 'single'; scope: 'session'; owner: ArchifyViewerProps }
  }
}
...
export type ResearchViewProps = PropsRuntime<'conversation.view'>
  & PropsRenderSlots<'research.view.diagram'>
  & PropsStore<ReturnType<typeof createResearchViewStore>>
  & PropsLocale<'research.view'> & InjectFace<ResearchViewInjected>
