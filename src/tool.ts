...
import { researchNotebookGuide } from './notebook.ts'
import type { ResearchGlossaryPatch, ResearchId, ResearchState, ResearchPlanReadResult } from './types.ts'
import type { PlanVersionRef } from './plan-schema.ts'
...
function planRefValue(ref: PlanVersionRef) {
  return { plan_id: ref.planId, revision: ref.revision, sha256: ref.sha256 }
}

function planValue(value: ResearchPlanReadResult) {
